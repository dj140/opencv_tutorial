...
while True:
	...
	if len(cnts) > 0:
		...
		if posx < 320 and uposx >= 6400:
			uposx = uposx - 15
		elif posx > 320 and uposx <= 6820:
			uposx = uposx + 15

		if posy < 240 and uposy >= 6600:
			uposy = uposy - 15
		elif posy > 240 and uposy <= 6920:
			uposy = uposy + 15
		#uposx = str(int(6660+(posx-320-int(radius))*1.125))
		#uposy = str(int(6660+(posy-240-int(radius))*1.5))
		#uposy = str(int(6660+(240-posy-int(radius))*1.5))


		xy = str(str(uposx)+str(uposy))
		#print(uposx+uposy)
